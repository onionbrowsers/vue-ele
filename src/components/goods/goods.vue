            ...
            <div class="foods-wrapper" ref="foodWrapper">
                <ul>
                    <li v-for="(item, index) in goods" :key="index" class="food-list food-list-hook">
                        ...
                        <ul>
                            <li v-for="(ele, index) in item.foods" @click="selectFood($event, ele)"
                            :key="index" class="food-item border-1px">
                                <div class="icon">
                                    <img width="57" height="57" :src="ele.icon" alt="">
                                </div>
                                <div class="content">
                                    <h2 class="name">
                                        {{ele.name}}
                                    </h2>
                                    <p class="desc" v-show="ele.description">{{ele.description}}</p>
                                    <div class="extra">
                                    ...
                                    <div class="price">
                                        ...
                                        <span class="old" v-show="ele.oldPrice">￥{{ele.oldPrice}}</span>
                                    </div>
