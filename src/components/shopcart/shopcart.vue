...
export default {
    ...
    computed: {
        ...
        payDesc () {
            if (this.totalPrice === 0) {
                ...
                let cutPrice = this.minPrice - this.totalPrice
                return `还差${cutPrice}元起送`
            } else {
                return '去结算'
            }
        }
    ...
    methods: {
        ...
        pay () {
            ...
            let curPrice = this.totalPrice + this.deliveryPrice
            window.alert(`需支付${curPrice}元`)
        }
    },
    components: {
        cartcontrol
